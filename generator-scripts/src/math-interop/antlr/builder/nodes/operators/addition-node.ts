...
export class AdditionNode implements MathStringBuilderNode {
	...
	public execute(): string {
		return HighLevelTsc.buildBinaryOperatorCode(this._valueA, this._valueB, BinaryOperatorType.Add);
	}
}