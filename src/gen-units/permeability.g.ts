...
export class Permeability extends BaseUnit {
     ...
     */
    public toString(unit: PermeabilityUnits = PermeabilityUnits.HenriesPerMeter, options?: number | ToStringOptions): string {
        ...
        switch (unit) {
            ...
            case PermeabilityUnits.HenriesPerMeter:
                return super.truncateFractionDigits(this.HenriesPerMeter, options as ToStringOptions) + ` H/m`;
        default:
            break;
        }
