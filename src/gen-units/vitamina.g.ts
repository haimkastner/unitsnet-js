...
export class VitaminA extends BaseUnit {
     ...
     */
    public toString(unit: VitaminAUnits = VitaminAUnits.InternationalUnits, options?: number | ToStringOptions): string {
        ...
        switch (unit) {
            ...
            case VitaminAUnits.InternationalUnits:
                return super.truncateFractionDigits(this.InternationalUnits, options as ToStringOptions) + ` IU`;
        default:
            break;
        }
