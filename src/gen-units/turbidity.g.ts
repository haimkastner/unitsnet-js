...
export class Turbidity extends BaseUnit {
     ...
     */
    public toString(unit: TurbidityUnits = TurbidityUnits.NTU, options?: number | ToStringOptions): string {
        ...
        switch (unit) {
            ...
            case TurbidityUnits.NTU:
                return super.truncateFractionDigits(this.NTU, options as ToStringOptions) + ` NTU`;
        default:
            break;
        }
