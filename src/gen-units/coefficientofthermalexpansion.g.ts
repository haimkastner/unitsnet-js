...
export class CoefficientOfThermalExpansion extends BaseUnit {
     ...
     */
    public toString(unit: CoefficientOfThermalExpansionUnits = CoefficientOfThermalExpansionUnits.PerKelvin, options?: number | ToStringOptions): string {
        ...
        switch (unit) {
            ...
            case CoefficientOfThermalExpansionUnits.PerKelvin:
                return super.truncateFractionDigits(this.PerKelvin, options as ToStringOptions) + ` K⁻¹`;
            case CoefficientOfThermalExpansionUnits.PerDegreeCelsius:
                return super.truncateFractionDigits(this.PerDegreeCelsius, options as ToStringOptions) + ` °C⁻¹`;
            case CoefficientOfThermalExpansionUnits.PerDegreeFahrenheit:
                return super.truncateFractionDigits(this.PerDegreeFahrenheit, options as ToStringOptions) + ` °F⁻¹`;
            case CoefficientOfThermalExpansionUnits.PpmPerKelvin:
                return super.truncateFractionDigits(this.PpmPerKelvin, options as ToStringOptions) + ` ppm/K`;
            case CoefficientOfThermalExpansionUnits.PpmPerDegreeCelsius:
                return super.truncateFractionDigits(this.PpmPerDegreeCelsius, options as ToStringOptions) + ` ppm/°C`;
            case CoefficientOfThermalExpansionUnits.PpmPerDegreeFahrenheit:
                return super.truncateFractionDigits(this.PpmPerDegreeFahrenheit, options as ToStringOptions) + ` ppm/°F`;
        default:
            break;
        }
